 ...
 */
inline void add_f64_sse2(const double *a, const double *b, double *out,
                         std::size_t n) {
  std::size_t i = 0;
 ...
 */
inline void add_f32_sse(const float *a, const float *b, float *out,
                        std::size_t n) {
  std::size_t i = 0;
 ...
 */
inline void mul_f64_sse2(const double *a, const double *b, double *out,
                         std::size_t n) {
  std::size_t i = 0;
  const std::size_t vec_end = n - (n % 2);
 ...
 */
inline void mul_f32_sse(const float *a, const float *b, float *out,
                        std::size_t n) {
  std::size_t i = 0;
  const std::size_t vec_end = n - (n % 4);
 ...
 */
inline void sub_f64_sse2(const double *a, const double *b, double *out,
                         std::size_t n) {
  std::size_t i = 0;
  const std::size_t vec_end = n - (n % 2);
 ...
 */
inline void sub_f32_sse(const float *a, const float *b, float *out,
                        std::size_t n) {
  std::size_t i = 0;
  const std::size_t vec_end = n - (n % 4);
 ...
 */
inline void div_f64_sse2(const double *a, const double *b, double *out,
                         std::size_t n) {
  std::size_t i = 0;
  const std::size_t vec_end = n - (n % 2);
 ...
 */
inline void div_f32_sse(const float *a, const float *b, float *out,
                        std::size_t n) {
  std::size_t i = 0;
  const std::size_t vec_end = n - (n % 4);
 ...
 */
inline void add_f64_avx(const double *a, const double *b, double *out,
                        std::size_t n) {
  std::size_t i = 0;
  const std::size_t vec_end = n - (n % 4);
 ...
 */
inline void add_f32_avx(const float *a, const float *b, float *out,
                        std::size_t n) {
  std::size_t i = 0;
 ...
 */
inline void mul_f64_avx(const double *a, const double *b, double *out,
                        std::size_t n) {
  std::size_t i = 0;
  const std::size_t vec_end = n - (n % 4);
 ...
 */
inline void mul_f32_avx(const float *a, const float *b, float *out,
                        std::size_t n) {
  std::size_t i = 0;
  const std::size_t vec_end = n - (n % 8);
 ...
 */
inline void sub_f64_avx(const double *a, const double *b, double *out,
                        std::size_t n) {
  std::size_t i = 0;
  const std::size_t vec_end = n - (n % 4);
 ...
 */
inline void sub_f32_avx(const float *a, const float *b, float *out,
                        std::size_t n) {
  std::size_t i = 0;
  const std::size_t vec_end = n - (n % 8);
 ...
 */
inline void div_f64_avx(const double *a, const double *b, double *out,
                        std::size_t n) {
  std::size_t i = 0;
  const std::size_t vec_end = n - (n % 4);
 ...
 */
inline void div_f32_avx(const float *a, const float *b, float *out,
                        std::size_t n) {
  std::size_t i = 0;
  const std::size_t vec_end = n - (n % 8);
 ...
 */
inline void add_f64_avx512(const double *a, const double *b, double *out,
                           std::size_t n) {
  std::size_t i = 0;
  const std::size_t vec_end = n - (n % 8);
 ...
 */
inline void add_f32_avx512(const float *a, const float *b, float *out,
                           std::size_t n) {
  std::size_t i = 0;
 ...
 */
inline void sub_f32_avx512(const float *a, const float *b, float *out,
                           std::size_t n) {
  std::size_t i = 0;
  const std::size_t vec_end = n - (n % 16);
 ...
 */
inline void div_f64_avx512(const double *a, const double *b, double *out,
                           std::size_t n) {
  std::size_t i = 0;
  const std::size_t vec_end = n - (n % 8);
 ...
 */
inline void div_f32_avx512(const float *a, const float *b, float *out,
                           std::size_t n) {
  std::size_t i = 0;
  const std::size_t vec_end = n - (n % 16);
 ...
 */
inline void add_f32_neon(const float *a, const float *b, float *out,
                         std::size_t n) {
  std::size_t i = 0;
  const std::size_t vec_end = n - (n % 4);
 ...
 */
inline void mul_f32_neon(const float *a, const float *b, float *out,
                         std::size_t n) {
  std::size_t i = 0;
  const std::size_t vec_end = n - (n % 4);
 ...
 */
inline void sub_f32_neon(const float *a, const float *b, float *out,
                         std::size_t n) {
  std::size_t i = 0;
  const std::size_t vec_end = n - (n % 4);
 ...
 */
inline void div_f32_neon(const float *a, const float *b, float *out,
                         std::size_t n) {
  std::size_t i = 0;
  const std::size_t vec_end = n - (n % 4);
