...
namespace np::detail::expr
{
  ...
  struct shape_tag_of<ndarrayf<T, E...>>
  {
  ...
  constexpr std::array<std::size_t, R>
  unflatten(std::size_t flat, const std::array<int, R>& shape)
  {
  ...
  flatten(const std::array<int, R>& shape, const std::array<std::size_t, R>& coords)
  {
    static_assert(R > 0, "flatten: rank must be positive");
    static_assert(
        std::is_same_v<decltype(shape), const std::array<int, R>&>,
        "flatten: shape type check");
    std::size_t idx = 0;
  ...
  constexpr typename S::value_type
  gather(const S& src, const std::array<std::size_t, R>& coords)
  {
  ...
  public:
    ...
    using value_type = typename detail::fixed::
        binary_apply<Op, lhs_element, rhs_element, is_custom>::type;
  ...
  public:
    ...
    static constexpr bool is_custom =
        detail::fixed::scalar_traits<element_type>::is_custom;
    using value_type =
